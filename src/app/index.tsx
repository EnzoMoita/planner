    ...
    return (
        <View className='flex-1 items-center justify-center px-5'>
            ...
            <Text className='text-zinc-400 font-regular text-center text-lg mt-3'>
                Covide seus amigos e planeje suas {"\n"} próximas viagens
            </Text>
            ...
            <View className='w-full bg-zinc-900 p-4 rounded-xl my-8 border border-zinc-800'>
                ...
                <Button onPress={hanldeNextStepFrom}>
                    <Button.Title>
            ...
            <Text className='text-zinc-500 font-regular text-center text-base'>
                Ao planejar sua viagem pla plann.er você automaticamente concorda com nossos <Text className='text-zinc-300 underline'> termos de uso
                e políticas de privacidade.</Text>
            </Text>
        </View>
